...
import { Grid, RefreshCw, DollarSign, Layers, ArrowUp, ArrowDown, ShieldCheck, Database, CheckCircle2 } from "lucide-react";
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
        ...
        <div className="rounded-lg border border-gray-800 bg-gray-900/70 p-3">
          ...
          <span className="text-[10px] text-emerald-400 flex items-center gap-1 mt-0.5">
            <ShieldCheck className="h-3 w-3" /> Mark in sweet spot
          </span>
        </div>
      </div>
